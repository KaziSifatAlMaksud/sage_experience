...
{
    /**
     * Determine whether the user can view any practices (for navigation/sidebar).
     */
    public function viewAny(User $user): bool
    {
        return $user->hasRole(['admin', 'project_advisor']);
    }

    /**
     * Determine whether the user can view a specific practice.
     */
