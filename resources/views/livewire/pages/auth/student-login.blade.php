...
new #[Layout('layouts.guest')] class extends Component
{
    ...
    public function login(): void
    {
        ...
        if (!auth()->user()->isStudent()) {
            ...
            // Set error message
            $this->errorMessage = 'Only students can login here. Please use the appropriate login page.';
...
<div>
    ...
    <div class="text-center mb-6">
        ...
        <p class="mt-2 text-sm text-gray-600">For students only</p>
    </div>
    ...
    <div class="mt-6">
        ...
        <div class="mt-6">
            ...
            <a href="{{ route('facebook.login') }}" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white hover:bg-gray-50 text-sm font-medium text-gray-500 hover:text-gray-900 mt-3">
                <svg class="w-5 h-5 mr-2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
