...
new #[Layout('layouts.guest')] class extends Component
{
    ...
    public function login(): void
    {
        ...
        if (!auth()->user()->isAdmin()) {
            ...
            // Set error message
            $this->errorMessage = 'Only administrators can login here. Please use the appropriate login page.';
...
<div>
    ...
    <div class="text-center mb-6">
        ...
        <p class="mt-2 text-sm text-gray-600">For administrators only</p>
    </div>
    ...
    <div class="mt-6">
        ...
        <div class="mt-6">
            ...
            <div class="mt-4 flex justify-between">
                <a href="{{ route('student.login') }}" class="inline-flex items-center text-sm text-gray-600 hover:text-gray-900">
                ...
                <a href="{{ route('instructor.login') }}" class="inline-flex items-center text-sm text-gray-600 hover:text-gray-900">
                    {{ __('Instructor Login') }}
