                ...
                @else
                    <div class="space-y-4">
                        ...
                        @foreach($areaGroups as $areaId => $practicesByArea)
                            ...
                            @endphp
                            <div class="border rounded-lg overflow-hidden bg-white shadow" style="border-top: 4px solid {{ $area->color }};">
                                    ...
                                    @foreach($sortedSkills as $skillId => $practicesBySkill)
                                        ...
                                        <div class="mb-2">
                                            <div class="flex items-center justify-between">
                                                ...
                                                @if($count)
                                                    <span style="color: {{ $area->color }};" class="font-bold mr-4 my-auto  {{ $fontSize }}">{{ $count }}</span>
                                                @endif
                                                <div class="font-medium text-center my-auto text-base text-gray-800"> {{ $skill->name }}</div>
                            </div>
                                            </div>
