...
<a
    ...
    class="fi-dropdown-item flex  items-center gap-2  text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-800"
    style="padding:6px 6px 12px 12px"
>
